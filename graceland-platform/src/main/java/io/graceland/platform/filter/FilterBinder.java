...
/**
 * Used to create and bind a {@link io.graceland.platform.filter.FilterSpec}.
 *
 * @see io.graceland.platform.filter.FilterSpec
 * @see io.graceland.platform.filter.FilterProvider
 * @see io.graceland.platform.filter.FilterPattern
 */
public class FilterBinder {
     ...
     * {@link io.graceland.platform.filter.FilterProvider} as the provider.
     *
    ...
    /**
     * Sets the priority of the filter. If none is set, the {@link io.graceland.platform.filter.FilterBinder#DEFAULT_PRIORITY}
     * is used.
     *
    ...
    /**
     * Adds a {@link io.graceland.platform.filter.FilterPattern} to the final filter. You can add more than one with the binder.
     *
    ...
    /**
     * Builds a {@link io.graceland.platform.filter.FilterSpec} and adds it to the Guice dependency graph.
     */
    public void bind() {
